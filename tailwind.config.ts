  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        mysql: "hsl(var(--mysql-color))",
        angular: "hsl(var(--angular-color))",
        vue: "hsl(var(--vue-color))",
        react: "hsl(var(--react-color))",
        kotlin: "hsl(var(--kotlin-color))",
        postgresql: "hsl(var(--postgresql-color))",
        jquery: "hsl(var(--jquery-color))",
        numpy: "hsl(var(--numpy-color))",
        pandas: "hsl(var(--pandas-color))",
        django: "hsl(var(--django-color))",
        r: "hsl(var(--r-color))",
        go: "hsl(var(--go-color))",
        swift: "hsl(var(--swift-color))",
        bash: "hsl(var(--bash-color))",
        scipy: "hsl(var(--scipy-color))",
        ...
        ai: "hsl(var(--ai-color))",
        genai: "hsl(var(--genai-color))",
        "intro-programming": "hsl(var(--intro-programming-color))",
        accessibility: "hsl(var(--accessibility-color))",
        "intro-html-css": "hsl(var(--intro-html-css-color))",
      ...
      animation: {
        ...
        "glitch-skew": "glitch-skew 3s ease-in-out infinite",
      },
    },
  },
  plugins: [animate],
