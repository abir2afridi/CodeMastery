...
import { technologies, categories } from "@/data/webdev/technologies";
...
import PageHero from "@/components/webdev/PageHero";
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-5">
              {categoryTechCounts.slice(0, 6).map(cat => (
                <Link key={cat.id} to={`/web-dev/category/${cat.slug}`} className="block group">
                ...
                <tbody className="divide-y divide-border/20">
                  {ranked.map((tech, i) => (
                    <tr key={tech.id} className="group hover:bg-white/80 dark:hover:bg-slate-900/50 transition-all">
                      ...
                      <td className="p-4">
                        <Link to={`/web-dev/tech/${tech.slug}`} className="flex items-center gap-4 group/link">
                          <div className="size-10 flex items-center justify-center shrink-0">
                            {tech.logo ? (
                      ...
                      <td className="p-4 text-center">
                        <Link to={`/web-dev/tech/${tech.slug}`} className="inline-flex items-center justify-center size-9 rounded-xl bg-slate-50 dark:bg-slate-900 border border-border/40 group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all">
