...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden font-sans">
      <Link to="/web-dev" className="absolute top-8 left-8 flex items-center gap-2 text-slate-300 hover:text-foreground transition-colors group">
