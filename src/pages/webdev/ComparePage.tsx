...
import { getTechBySlug, technologies, Technology } from "@/data/webdev/technologies";
  ...
  if (techsToCompare.length < 2) {
    return (
      <div className="space-y-12 animate-fade-in pb-20">
        ...
        >
          <Button variant="outline" onClick={() => navigate("/web-dev")} className="rounded-xl border-white/10 h-11 px-6 font-black text-[10px] uppercase tracking-widest text-[#210c6e] hover:bg-slate-50">
