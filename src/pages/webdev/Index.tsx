...
import { categories, technologies } from "@/data/webdev/technologies";
...
import { LiveTicker } from "@/components/webdev/LiveTicker";
      ...
      <section className="relative py-10 overflow-hidden">
        ...
        <div className="relative text-center space-y-8 max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
             <Link to="/web-dev/ranking" className="group">
             ...
             <Link to="/web-dev/roadmaps" className="group">
      ...
      <section className="space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {populatedCategories.map((cat) => (
            <Link key={cat.id} to={`/web-dev/category/${cat.slug}`} className="group relative">
      ...
      <section className="space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {technologies.map((tech) => (
            <Link key={tech.id} to={`/web-dev/tech/${tech.slug}`}
