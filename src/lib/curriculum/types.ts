export type TrackId = "html" | "css" | "javascript" | "python" | "typescript" | "c" | "cpp" | "java" | "csharp" | "w3css" | "colors" | "php" | "htmldom" | "bootstrap3" | "bootstrap4" | "bootstrap5" | "sql" | "mysql" | "angular" | "vue" | "react" | "kotlin" | "postgresql" | "jquery" | "numpy" | "pandas" | "django" | "r" | "go" | "swift" | "bash" | "scipy" | "mongodb" | "excel" | "dsa" | "xml" | "json" | "nodejs" | "asp" | "cybersecurity" | "aws" | "machinelearning" | "statistic" | "rwd" | "ajax" | "rust" | "matplotlib" | "unicode_utf8" | "raspberry_pi" | "ai" | "genai" | "intro-programming" | "accessibility" | "intro-html-css" | "codegame" | "google-sheets" | "typing-speed" | "svg" | "icons" | "canvas" | "emojis";
export type Difficulty = "Absolute Beginner" | "Beginner" | "Intermediate" | "Advanced" | "Expert";

export interface CodeSnippet { html?: string; css?: string; javascript?: string; python?: string; c?: string; cpp?: string; java?: string; csharp?: string; php?: string; kotlin?: string; postgresql?: string; jquery?: string; numpy?: string; pandas?: string; django?: string; r?: string; go?: string; swift?: string; bash?: string; scipy?: string; mongodb?: string; excel?: string; dsa?: string; xml?: string; json?: string; nodejs?: string; asp?: string; cybersecurity?: string; aws?: string; machinelearning?: string; statistic?: string; rwd?: string; ajax?: string; rust?: string; matplotlib?: string; unicode_utf8?: string; raspberry_pi?: string; ai?: string; genai?: string; "intro-programming"?: string; accessibility?: string; "intro-html-css"?: string; codegame?: string; "google-sheets"?: string; "typing-speed"?: string; svg?: string; icons?: string; emojis?: string; canvas?: string; }
...
export interface Track {
  ...
  brandColor: string;
  glowColor: string;
  // Learning taxonomy fields (optional - added by enrichedTracks)
