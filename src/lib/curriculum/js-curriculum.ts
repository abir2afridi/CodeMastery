...
const part2: Chapter[] = [
  ...
  jsCh12,
  jsCh13,
  makeStub(14, "Arrays — Advanced Methods", "find, sort, flat, flatMap, every/some.", "Intermediate", "Part 2: Working With Data", "js-ch-13"),
  makeStub(15, "Object Property Control", "Property descriptors, freeze, seal.", "Advanced", "Part 2: Working With Data", "js-ch-14"),
  makeStub(16, "Date and Time", "Working with dates.", "Beginner", "Part 2: Working With Data", "js-ch-15"),
  makeStub(17, "Regular Expressions — Part 1", "Pattern basics.", "Intermediate", "Part 2: Working With Data", "js-ch-16"),
  makeStub(18, "Regular Expressions — Part 2", "Groups, lookarounds, real uses.", "Advanced", "Part 2: Working With Data", "js-ch-17"),
  makeStub(19, "JSON", "Parse, stringify, common pitfalls.", "Beginner", "Part 2: Working With Data", "js-ch-18"),
  makeStub(20, "Map, Set, WeakMap, WeakSet", "Modern collections.", "Intermediate", "Part 2: Working With Data", "js-ch-19"),
];

const part3: Chapter[] = [
  makeStub(21, "Scope", "Global, function, block.", "Intermediate", "Part 3: Scope, Closures, OOP", "js-ch-20"),
  makeStub(22, "Closures Deep Dive", "Real use cases.", "Intermediate", "Part 3: Scope, Closures, OOP", "js-ch-21"),
  makeStub(23, "Hoisting", "Full explanation.", "Intermediate", "Part 3: Scope, Closures, OOP", "js-ch-22"),
  makeStub(24, "Prototype Chain", "How JS inheritance works.", "Advanced", "Part 3: Scope, Closures, OOP", "js-ch-23"),
  makeStub(25, "Classes — Part 1", "Basics, constructor, methods.", "Intermediate", "Part 3: Scope, Closures, OOP", "js-ch-24"),
  makeStub(26, "Classes — Part 2", "Inheritance, private fields, static.", "Advanced", "Part 3: Scope, Closures, OOP", "js-ch-25"),
  makeStub(27, "The this Keyword", "Complete guide.", "Advanced", "Part 3: Scope, Closures, OOP", "js-ch-26"),
  makeStub(28, "Map, Set, WeakMap, WeakSet", "Modern collections.", "Intermediate", "Part 3: Scope, Closures, OOP", "js-ch-27"),
  makeStub(29, "Iterators & Generators", "Custom iteration.", "Advanced", "Part 3: Scope, Closures, OOP", "js-ch-28"),
  makeStub(30, "Symbols & Metaprogramming", "Advanced features.", "Expert", "Part 3: Scope, Closures, OOP", "js-ch-29"),
];

const part4: Chapter[] = [
  makeStub(31, "JS Runtime", "Event loop, call stack, queues.", "Advanced", "Part 4: Async JavaScript", "js-ch-30"),
  makeStub(32, "Callbacks", "And callback hell.", "Intermediate", "Part 4: Async JavaScript", "js-ch-31"),
  makeStub(33, "Promises — Part 1", "Promise basics.", "Intermediate", "Part 4: Async JavaScript", "js-ch-32"),
  makeStub(34, "Promises — Part 2", "all, race, allSettled, any.", "Advanced", "Part 4: Async JavaScript", "js-ch-33"),
  makeStub(35, "Async/Await", "Modern async syntax.", "Intermediate", "Part 4: Async JavaScript", "js-ch-34"),
  makeStub(36, "Fetch API", "HTTP from JavaScript.", "Intermediate", "Part 4: Async JavaScript", "js-ch-35"),
  makeStub(37, "Working with REST APIs", "Real-world data fetching.", "Intermediate", "Part 4: Async JavaScript", "js-ch-36"),
  makeStub(38, "Error Handling", "try/catch, custom errors.", "Intermediate", "Part 4: Async JavaScript", "js-ch-37"),
  makeStub(39, "JSON", "Parse, stringify.", "Beginner", "Part 4: Async JavaScript", "js-ch-38"),
  makeStub(40, "Browser Storage", "localStorage, sessionStorage, cookies.", "Intermediate", "Part 4: Async JavaScript", "js-ch-39"),
];

const part5: Chapter[] = [
  makeStub(41, "The DOM — Intro", "What it is, how it forms.", "Beginner", "Part 5: DOM and Browser", "js-ch-40"),
  makeStub(42, "Selecting Elements", "querySelector and friends.", "Beginner", "Part 5: DOM and Browser", "js-ch-41"),
  makeStub(43, "Reading & Changing Content", "textContent, innerHTML.", "Beginner", "Part 5: DOM and Browser", "js-ch-42"),
  makeStub(44, "Creating, Adding, Removing Elements", "createElement, append, remove.", "Intermediate", "Part 5: DOM and Browser", "js-ch-43"),
  makeStub(45, "Attributes, Classes, Styles", "classList, dataset, style.", "Intermediate", "Part 5: DOM and Browser", "js-ch-44"),
  makeStub(46, "Events — Part 1", "addEventListener, event object.", "Intermediate", "Part 5: DOM and Browser", "js-ch-45"),
  makeStub(47, "Events — Part 2", "Bubbling, capturing, delegation.", "Advanced", "Part 5: DOM and Browser", "js-ch-46"),
  makeStub(48, "Forms in JavaScript", "Capturing input, validation.", "Intermediate", "Part 5: DOM and Browser", "js-ch-47"),
  makeStub(49, "Timers", "setTimeout, setInterval, RAF.", "Intermediate", "Part 5: DOM and Browser", "js-ch-48"),
  makeStub(50, "Scroll & Intersection Observer", "Modern scroll APIs.", "Advanced", "Part 5: DOM and Browser", "js-ch-49"),
  makeStub(51, "Drag & Drop API", "Native drag and drop.", "Advanced", "Part 5: DOM and Browser", "js-ch-50"),
  makeStub(52, "IndexedDB", "Browser-side database.", "Advanced", "Part 5: DOM and Browser", "js-ch-51"),
  makeStub(53, "Web APIs Collection", "Clipboard, share, vibration.", "Intermediate", "Part 5: DOM and Browser", "js-ch-52"),
  makeStub(54, "Canvas API", "Drawing with JavaScript.", "Advanced", "Part 5: DOM and Browser", "js-ch-53"),
  makeStub(55, "Web Workers", "Threading in the browser.", "Advanced", "Part 5: DOM and Browser", "js-ch-54"),
];

const part6: Chapter[] = [
  makeStub(56, "ES Modules", "import/export, dynamic import.", "Intermediate", "Part 6: Modern JS", "js-ch-55"),
  makeStub(57, "Functional Programming", "Pure functions, immutability.", "Advanced", "Part 6: Modern JS", "js-ch-56"),
  makeStub(58, "Design Patterns", "Singleton, observer, factory, strategy.", "Advanced", "Part 6: Modern JS", "js-ch-57"),
  makeStub(59, "TypeScript Intro", "Why types matter.", "Intermediate", "Part 6: Modern JS", "js-ch-58"),
  makeStub(60, "Build Tools", "npm, Vite, Webpack basics.", "Intermediate", "Part 6: Modern JS", "js-ch-59"),
  makeStub(61, "Testing", "Vitest, unit tests, async tests.", "Intermediate", "Part 6: Modern JS", "js-ch-60"),
  makeStub(62, "JS Security", "XSS, CSRF, CSP.", "Advanced", "Part 6: Modern JS", "js-ch-61"),
  makeStub(63, "Performance", "Optimization patterns.", "Advanced", "Part 6: Modern JS", "js-ch-62"),
  makeStub(64, "Debugging Techniques", "DevTools, breakpoints.", "Intermediate", "Part 6: Modern JS", "js-ch-63"),
  makeStub(65, "Memory Management", "GC, leaks, weak refs.", "Advanced", "Part 6: Modern JS", "js-ch-64"),
];
