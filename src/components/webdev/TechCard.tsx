import { Technology, getCategoryById } from "@/data/webdev/technologies";
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col h-full">
        ...
        <Link to={`/web-dev/tech/${tech.slug}`} className="flex items-center gap-3 mb-4 group/link">
        ...
        <div className="flex items-center gap-2 mt-auto">
          <Link to={`/web-dev/tech/${tech.slug}`} className="flex-1">
            <Button 
